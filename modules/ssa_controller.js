...
ssa.controller = function(form, widgets) {
  var self = this;
...
ssa.controller.prototype.show = function() {
	this.form.show();  
};

ssa.controller.prototype.control = function(id) {
	return this.form[id];  
};

ssa.controller.prototype.manageWidget = function(widgetId, defaultVisibility, ptags) {
...
*/
ssa.controller.prototype.header = function(id) {
...
ssa.controller.prototype.footer = function(id) {
